    ...
    public partial class main_init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplementTypes", x => x.TypeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeficiencySymptoms = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Supplements_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IntakeLogs", x => x.LogID);
                    table.ForeignKey(
                        name: "FK_IntakeLogs_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplementTypeRelations", x => x.RelationID);
                    table.ForeignKey(
                        name: "FK_SupplementTypeRelations_SupplementTypes_TypeID",
                        column: x => x.TypeID,
                        principalTable: "SupplementTypes",
                        principalColumn: "TypeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplementTypeRelations_Supplements_SupplementID",
                        column: x => x.SupplementID,
                        principalTable: "Supplements",
                        principalColumn: "SupplementID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Supplements_CreatorId",
                table: "Supplements",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Supplements_Name_CreatorId",
                table: "Supplements",
                columns: new[] { "Name", "CreatorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SupplementTypeRelations_SupplementID",
                table: "SupplementTypeRelations",
                column: "SupplementID");

            migrationBuilder.CreateIndex(
                name: "IX_SupplementTypeRelations_TypeID",
                table: "SupplementTypeRelations",
                column: "TypeID");

            migrationBuilder.CreateIndex(
                name: "IX_SupplementTypes_Name",
